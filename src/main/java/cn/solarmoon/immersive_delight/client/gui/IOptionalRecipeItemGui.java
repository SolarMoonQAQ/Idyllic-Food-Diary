...
public class IOptionalRecipeItemGui {
    ...
    public static void render(GuiGraphics graphics, String backgroundResId) {
        ...
        boolean show = pin.recipeMatches() && player.isCrouching();
        ...
        // 渲染贴图
        poseStack.pushPose();
        ResourceLocation texture = new ResourceLocation(ImmersiveDelight.MOD_ID, "textures/gui/" + backgroundResId + ".png");
        int textureX = 0;
        int textureY = 0;
        int width = 64;
        int height = 64;
        ...
        if (show && pin.getOptionalOutputs() != null) {
