package cn.solarmoon.immersive_delight.client.tooltip;
...
public class TankableTooltipRenderer implements ClientTooltipComponent {
    ...
    public int getHeight() {
        return canBeRendered() ? size + 10 + height : 0;
    }
    ...
    public void drawText(PoseStack poseStack, FluidStack fluidStack, Font font, GuiGraphics guiGraphics, int x, int y) {
        ...
        if(!fluidStack.isEmpty()) {
            ...
            guiGraphics.drawString(font, ImmersiveDelight.TRANSLATOR.set("tooltip", "fluid_empty"), x + 2 + deltaF, y + 4 + height + hOffset, 0xFFFFFF);
        }
    }
