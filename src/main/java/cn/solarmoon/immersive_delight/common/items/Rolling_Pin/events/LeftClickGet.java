package cn.solarmoon.immersive_delight.common.items.Rolling_Pin.events;
...
import static cn.solarmoon.immersive_delight.particles.methods.Sweep.sweep;

public class LeftClickGet {
    ...
    public void sweepHarvest(PlayerInteractEvent.LeftClickEmpty event) {
        ...
        harvest(0, player, event.getLevel());
    }

    private void harvest(int radius, Player player, Level level) {
