...
import cn.solarmoon.idyllic_food_diary.common.item.CulinaryTreasureItem;
import cn.solarmoon.idyllic_food_diary.common.item.block_item.*;
import cn.solarmoon.idyllic_food_diary.common.item.equipment.BathrobeItem;
import cn.solarmoon.idyllic_food_diary.common.item.food.containable.SimpleFoodContainerBlockItem;
import cn.solarmoon.idyllic_food_diary.common.item.food.containable.SimpleFoodContainerItem;
import cn.solarmoon.idyllic_food_diary.common.item.food.containable.SoupBowlFoodItem;
import cn.solarmoon.idyllic_food_diary.common.item.product.DurianFleshItem;
import cn.solarmoon.idyllic_food_diary.common.item.product.DurianItem;
import cn.solarmoon.idyllic_food_diary.common.item.product.GarlicItem;
import cn.solarmoon.idyllic_food_diary.common.item.recipe_item.ChineseCleaverItem;
import cn.solarmoon.idyllic_food_diary.common.item.recipe_item.RollingPinItem;
...
import cn.solarmoon.solarmoon_core.api.common.item.*;
import cn.solarmoon.solarmoon_core.api.registry.IRegister;
import cn.solarmoon.solarmoon_core.api.registry.object.ItemEntry;
...
public enum IMItems implements IRegister {
    ...
    //蒸笼底座
    public static final ItemEntry<SteamerBaseItem> STEAMER_BASE = IdyllicFoodDiary.REGISTRY.item()
            .id("steamer_base")
    ...
    //碗装蛋液
    public static final ItemEntry<SimpleFoodContainerBlockItem> EGG_LIQUID_BOWL = IdyllicFoodDiary.REGISTRY.item()
            .id("egg_liquid_bowl")
            .bound(() -> new SimpleFoodContainerBlockItem(
                    Items.BOWL,
    ...
    //鸡蛋羹
    public static final ItemEntry<SimpleFoodContainerBlockItem> STEAMED_EGG_CUSTARD = IdyllicFoodDiary.REGISTRY.item()
    ...
    public static final ItemEntry<SoupBowlFoodItem> PUMPKIN_SOUP = IdyllicFoodDiary.REGISTRY.item()
            .id("pumpkin_soup")
            .bound(() -> new SoupBowlFoodItem("immersive_delight:pumpkin_soup_fluid",
    ...
    public static final ItemEntry<SoupBowlFoodItem> SEAWEED_EGG_DROP_SOUP = IdyllicFoodDiary.REGISTRY.item()
            ...
            .bound(() -> new SoupBowlFoodItem("immersive_delight:seaweed_egg_drop_soup_fluid",
                    IMBlocks.SEAWEED_EGG_DROP_SOUP.get()))
            .build();

    //藏书羊肉汤
    public static final ItemEntry<SoupBowlFoodItem> CANGSHU_MUTTON_SOUP = IdyllicFoodDiary.REGISTRY.item()
            .id("cangshu_mutton_soup")
            .bound(() -> new SoupBowlFoodItem("immersive_delight:cangshu_mutton_soup_fluid",
    ...
    //未烹饪的清蒸鲑鱼
    public static final ItemEntry<SimpleFoodContainerItem> UNCOOKED_STEAMED_SALMON = IdyllicFoodDiary.REGISTRY.item()
            .id("uncooked_steamed_salmon")
            .bound(() -> new SimpleFoodContainerItem(
    ...
    //未烹饪的烤乳猪
    public static final ItemEntry<SimpleFoodContainerItem> UNCOOKED_ROASTED_SUCKLING_PIG = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的蒜酥蒸南瓜
    public static final ItemEntry<SimpleFoodContainerItem> UNCOOKED_STEAMED_PUMPKIN_WITH_CHOPPED_GARLIC = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的香菇蒸鸡
    public static final ItemEntry<SimpleFoodContainerItem> UNCOOKED_STEAMED_CHICKEN_WITH_MUSHROOM = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的荷叶鸡
    public static final ItemEntry<SimpleFoodContainerItem> UNCOOKED_STEAMED_LOTUS_LEAF_CHICKEN = IdyllicFoodDiary.REGISTRY.item()
            .id("uncooked_steamed_lotus_leaf_chicken")
            .bound(() -> new SimpleFoodContainerItem(
                    WOODEN_PLATE.get(),
                    FoodProperty.PRIMARY_HUNGER_PRODUCT_1)
            )
    ...
    //碗装香菇蒸鸡
    public static final ItemEntry<SimpleFoodContainerBlockItem> STEAMED_CHICKEN_WITH_MUSHROOM_BOWL = IdyllicFoodDiary.REGISTRY.item()
    ...
    //荷叶蒸鸡
    public static final ItemEntry<SimpleBlockItem> STEAMED_LOTUS_LEAF_CHICKEN = IdyllicFoodDiary.REGISTRY.item()
            .id("steamed_lotus_leaf_chicken")
            .bound(() -> new SimpleBlockItem(IMBlocks.STEAMED_LOTUS_LEAF_CHICKEN.get(), 16))
            .build();

    //荷叶蒸鸡肉
    public static final ItemEntry<SimpleFoodItem> STEAMED_LOTUS_LEAF_CHICKEN_MEAT = IdyllicFoodDiary.REGISTRY.item()
            .id("steamed_lotus_leaf_chicken_meat")
    ...
    //红茶叶
    public static final ItemEntry<SimpleItem> BLACK_TEA_LEAVES = IdyllicFoodDiary.REGISTRY.item()
            .id("black_tea_leaf")
    ...
    //绿茶叶
    public static final ItemEntry<SimpleItem> GREEN_TEA_LEAVES = IdyllicFoodDiary.REGISTRY.item()
            .id("green_tea_leaf")
            .bound(SimpleItem::new)
            .build();
    ...
    //榴莲肉
    public static final ItemEntry<DurianFleshItem> DURIAN_FLESH = IdyllicFoodDiary.REGISTRY.item()
            .id("durian_flesh")
    ...
    //帕秋莉手册联动
    public static final ItemEntry<CulinaryTreasureItem> CULINARY_TREASURE = IdyllicFoodDiary.REGISTRY.item()
