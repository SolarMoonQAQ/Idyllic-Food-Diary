...
import cn.solarmoon.idyllic_food_diary.common.fluid.*;
import cn.solarmoon.idyllic_food_diary.common.fluid.no_bucket.*;
import cn.solarmoon.solarmoon_core.api.registry.IRegister;
import cn.solarmoon.solarmoon_core.api.registry.object.FluidEntry;
...
public enum IMFluids implements IRegister {
    ...
    //藏书羊肉汤
    public static final FluidEntry CANGSHU_MUTTON_SOUP_FLUID = IdyllicFoodDiary.REGISTRY.fluid()
