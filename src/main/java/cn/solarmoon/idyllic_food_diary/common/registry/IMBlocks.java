...
import cn.solarmoon.idyllic_food_diary.common.block.SteamerLidBlock;
import cn.solarmoon.idyllic_food_diary.common.block.container.*;
import cn.solarmoon.idyllic_food_diary.common.block.crop.*;
import cn.solarmoon.idyllic_food_diary.common.block.entity_block.*;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.consume_food_block.SteamedSalmonBlock;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.long_press_eat_block.*;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.obtainable_food_block.SteamedLotusLeafChickenBlock;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.obtainable_food_block.RoastedSucklingPigBlock;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.obtainable_food_block.SteamedChickenWithMushroomBlock;
import cn.solarmoon.idyllic_food_diary.common.block.food_block.obtainable_food_block.SteamedPumpkinWithChoppedGarlicBlock;
import cn.solarmoon.idyllic_food_diary.common.block.product.DurianBlock;
import cn.solarmoon.idyllic_food_diary.common.level.feature.AppleTreeFeature;
import cn.solarmoon.idyllic_food_diary.common.level.feature.DurianTreeFeature;
import cn.solarmoon.solarmoon_core.api.registry.IRegister;
import cn.solarmoon.solarmoon_core.api.registry.object.BlockEntry;
...
public enum IMBlocks implements IRegister {
    ...
    //未烹饪的蛋挞
    public static final BlockEntry<UncookedCustardTartBlock> UNCOOKED_CUSTARD_TART = IdyllicFoodDiary.REGISTRY.block()
            .id("uncooked_custard_tart")
            .bound(UncookedCustardTartBlock::new)
            .build();
    ...
    //藏书羊肉汤
    public static final BlockEntry<BowlSoupBlock> CANGSHU_MUTTON_SOUP = IdyllicFoodDiary.REGISTRY.block()
    ...
    //荷叶蒸鸡
    public static final BlockEntry<SteamedLotusLeafChickenBlock> STEAMED_LOTUS_LEAF_CHICKEN = IdyllicFoodDiary.REGISTRY.block()
            .id("steamed_lotus_leaf_chicken")
            .bound(SteamedLotusLeafChickenBlock::new)
            .build();
