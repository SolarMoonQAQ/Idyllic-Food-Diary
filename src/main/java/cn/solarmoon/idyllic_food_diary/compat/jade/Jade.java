...
import cn.solarmoon.idyllic_food_diary.api.common.block.cookware.*;
...
public class Jade implements IWailaPlugin {
    ...
    public void registerClient(IWailaClientRegistration registration) {
        ...
        registration.registerBlockComponent(new TimeRecipeProgressProvider("soup_pot"), AbstractCookingPotEntityBlock.class);
