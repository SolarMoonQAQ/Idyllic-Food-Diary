...
public class TeaIngredientXX {

    public static final String TAG_KEY = "TeaIngredient";
    public static final String CUSTOM_NAME = "CustomName";
    public static final List<TeaIngredientXX> ALL = new ArrayList<>();
    ...
    public static TeaIngredientXX readFromNBT(CompoundTag nbt) {
        String json = nbt.getString(TAG_KEY);
        return SerializeHelper.GSON.fromJson(json, TeaIngredientXX.class);
    }

    public static List<TeaIngredientXX> readFromFluidStack(FluidStack fluidStack) {
        if (!fluidStack.isEmpty()) {
            String json = fluidStack.getOrCreateTag().getString(TAG_KEY);
            java.lang.reflect.Type type = new TypeToken<List<TeaIngredientXX>>() {
            }.getType();
            List<TeaIngredientXX> teaIngredients = SerializeHelper.GSON.fromJson(json, type);
    ...
    public static List<TeaIngredientXX> getAll() {
        return ALL;
    }
