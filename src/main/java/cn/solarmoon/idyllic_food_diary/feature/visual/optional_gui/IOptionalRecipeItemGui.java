package cn.solarmoon.idyllic_food_diary.feature.visual.optional_gui;
...
public class IOptionalRecipeItemGui {
    ...
    public static void render(GuiGraphics graphics, String backgroundResId) {
        ...
        RecipeSelectorData selector = CapabilityUtil.getData(player.getItemInHand(hand), SolarCapabilities.ITEMSTACK_DATA).getRecipeSelectorData();
