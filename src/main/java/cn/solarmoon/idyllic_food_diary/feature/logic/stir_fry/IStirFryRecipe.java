package cn.solarmoon.idyllic_food_diary.feature.logic.stir_fry;
...
public interface IStirFryRecipe extends IContainerBlockEntity, ITankBlockEntity, IHeatable, ISpiceable, IPendingResult {
    ...
    default Optional<StirFryRecipe> findStirFryRecipe() {
        ...
        return recipes.stream().filter(recipe -> {
            ...
            boolean heat = isHeatingConsiderStove();
