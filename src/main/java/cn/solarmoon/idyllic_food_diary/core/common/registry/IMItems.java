...
import cn.solarmoon.idyllic_food_diary.core.common.item.block_item.*;
import cn.solarmoon.idyllic_food_diary.core.common.item.equipment.BathrobeItem;
import cn.solarmoon.idyllic_food_diary.core.common.item.product.DurianItem;
import cn.solarmoon.idyllic_food_diary.core.common.item.product.GarlicItem;
import cn.solarmoon.idyllic_food_diary.core.common.item.recipe_item.ChineseCleaverItem;
...
public class IMItems {
    ...
    //未烹饪的叫花鸡
    public static final ItemEntry<SimpleFoodContainerBlockItem> UNCOOKED_BEGGARS_CHICKEN = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的香菇蒸鸡
    public static final ItemEntry<SimpleFoodContainerBlockItem> UNCOOKED_STEAMED_CHICKEN_WITH_MUSHROOM = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的蒜酥蒸南瓜
    public static final ItemEntry<SimpleFoodContainerBlockItem> UNCOOKED_STEAMED_PUMPKIN_WITH_CHOPPED_GARLIC = IdyllicFoodDiary.REGISTRY.item()
    ...
    //未烹饪的烤乳猪
    public static final ItemEntry<SimpleFoodContainerBlockItem> UNCOOKED_ROASTED_SUCKLING_PIG = IdyllicFoodDiary.REGISTRY.item()
