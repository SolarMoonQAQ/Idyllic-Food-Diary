...
public class SoupPotBlockEntity extends BaseTCBlockEntity implements ITimeRecipeBlockEntity<SoupPotRecipe>, IKettleRecipe, IBlockEntityAnimateTicker {
    ...
    public SoupPotBlockEntity(int maxCapacity, int size, int slotLimit, BlockPos pos, BlockState state) {
