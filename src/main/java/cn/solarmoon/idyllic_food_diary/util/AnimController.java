...
public class AnimController {
    ...
    public AnimController(Entity entity) {
        if (entity instanceof AbstractClientPlayer clientPlayer) {
            ...
            this.animation = (ModifierLayer<IAnimation>) PlayerAnimationAccess.getPlayerAssociatedData(player).get(new ResourceLocation(IdyllicFoodDiary.MOD_ID, "animation"));
        }
    }
    ...
    public void playAnim(int length, String anim) {
        ...
        animation.replaceAnimationWithFade(AbstractFadeModifier.functionalFadeIn(length, (modelName, type, value) -> value),
                new KeyframeAnimationPlayer(Objects.requireNonNull(PlayerAnimationRegistry.getAnimation(new ResourceLocation(IdyllicFoodDiary.MOD_ID, anim))))
