package cn.solarmoon.idyllic_food_diary.data.loot_tables;
...
public class IMBlockLoots extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(IMBlocks.ROASTED_SUCKLING_PIG_HEAD.get());
        ...
        dropSelf(IMBlocks.STEAMED_LOTUS_LEAF_CHICKEN.get());
