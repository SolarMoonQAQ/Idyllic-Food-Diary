...
import cn.solarmoon.idyllic_food_diary.element.matter.container.WoodenPlateBlock;
...
public class SteamedChickenWithMushroomBlock extends AbstractInteractiveFoodBlock {
    ...
    public static final VoxelShape SHAPE = Shapes.or(WoodenPlateBlock.SHAPE, Block.box(4, 1 , 4, 12, 6, 12));
    @Override
