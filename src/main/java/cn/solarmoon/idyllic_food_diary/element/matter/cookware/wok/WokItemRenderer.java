...
import cn.solarmoon.solarmoon_core.api.tile.TileItemFluidTankHelper;
...
public class WokItemRenderer extends BaseItemRenderer {
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext itemDisplayContext, PoseStack poseStack, MultiBufferSource buffer, int light, int overlay) {
        ...
        TileItemFluidTankHelper.getTank(stack).ifPresent(tank -> {
            TextureRenderUtil.renderStaticFluid(10/16f, 3/16f, 1/16f, tank, poseStack, buffer, light);
        });
