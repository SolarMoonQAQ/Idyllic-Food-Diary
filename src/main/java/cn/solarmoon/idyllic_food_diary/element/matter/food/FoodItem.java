...
public class FoodItem extends SimpleFoodBlockItem {

    public FoodItem(Block block, FoodProperties foodProperties) {
        super(block, foodProperties);
    }

    public FoodItem(Block block, int nutrition, float saturation, Supplier<MobEffectInstance> effectInstanceSupplier, float chance) {
        super(block, nutrition, saturation, effectInstanceSupplier, chance);
    }

    public FoodItem(Block block, int nutrition, float saturation) {
